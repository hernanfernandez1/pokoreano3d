...
const Data = (() => {
  ...
  const vocab = [
    ...
    // --- ampliación: día a día ---
    { han:"차",         rom:"cha",            es:"té / coche" },
    { han:"커피",       rom:"keopi",          es:"café" },
    { han:"우유",       rom:"uyu",            es:"leche" },
    { han:"빵",         rom:"ppang",          es:"pan" },
    { han:"고기",       rom:"gogi",           es:"carne" },
    { han:"생선",       rom:"saengseon",      es:"pescado" },
    { han:"야채",       rom:"yachae",         es:"verdura" },
    { han:"시장",       rom:"sijang",         es:"mercado" },
    { han:"가게",       rom:"gage",           es:"tienda" },
    { han:"돈",         rom:"don",            es:"dinero" },
    { han:"시간",       rom:"sigan",          es:"tiempo / hora" },
    { han:"오늘",       rom:"oneul",          es:"hoy" },
    { han:"내일",       rom:"naeil",          es:"mañana" },
    { han:"어제",       rom:"eoje",           es:"ayer" },
    { han:"아침",       rom:"achim",          es:"mañana / desayuno" },
    { han:"저녁",       rom:"jeonyeok",       es:"tarde-noche / cena" },
    { han:"길",         rom:"gil",            es:"camino / calle" },
    { han:"방",         rom:"bang",           es:"habitación" },
    { han:"문",         rom:"mun",            es:"puerta" },
    { han:"창문",       rom:"changmun",       es:"ventana" },
    { han:"의자",       rom:"uija",           es:"silla" },
    { han:"바다",       rom:"bada",           es:"mar" },
    { han:"산",         rom:"san",            es:"montaña" },
    { han:"하늘",       rom:"haneul",         es:"cielo" },
    { han:"꽃",         rom:"kkot",           es:"flor" },
    // --- medio ---
    { han:"날씨",       rom:"nalssi",         es:"tiempo (clima)", lvl:2 },
    { han:"기분",       rom:"gibun",          es:"estado de ánimo", lvl:2 },
    { han:"일하다",     rom:"ilhada",         es:"trabajar", lvl:2 },
    { han:"쉬다",       rom:"swida",          es:"descansar", lvl:2 },
    { han:"기다리다",   rom:"gidarida",       es:"esperar", lvl:2 },
    { han:"만나다",     rom:"mannada",        es:"encontrarse con", lvl:2 },
    { han:"살다",       rom:"salda",          es:"vivir", lvl:2 },
    { han:"주다",       rom:"juda",           es:"dar", lvl:2 },
    { han:"받다",       rom:"batda",          es:"recibir", lvl:2 },
    { han:"알다",       rom:"alda",           es:"saber", lvl:2 },
    // --- avanzado ---
    { han:"경험",       rom:"gyeongheom",     es:"experiencia", lvl:3 },
    { han:"기회",       rom:"gihoe",          es:"oportunidad", lvl:3 },
    { han:"환경",       rom:"hwangyeong",     es:"medio ambiente", lvl:3 },
    { han:"관계",       rom:"gwangye",        es:"relación", lvl:3 },
    { han:"결정하다",   rom:"gyeoljeonghada", es:"decidir", lvl:3 },
    { han:"설명하다",   rom:"seolmyeonghada", es:"explicar", lvl:3 },
    { han:"준비하다",   rom:"junbihada",      es:"preparar", lvl:3 },
    { han:"이해하다",   rom:"ihaehada",       es:"comprender", lvl:3 },
  ];
  ...
  const enVocab = at([
    ...
    // --- ampliación: día a día ---
    { han:"table",   rom:"teibol",  es:"mesa" },
    { han:"chair",   rom:"cher",    es:"silla" },
    { han:"window",  rom:"windou",  es:"ventana" },
    { han:"room",    rom:"rum",     es:"habitación" },
    { han:"kitchen", rom:"kitchen", es:"cocina" },
    { han:"garden",  rom:"garden",  es:"jardín" },
    { han:"tree",    rom:"tri",     es:"árbol" },
    { han:"flower",  rom:"flauer",  es:"flor" },
    { han:"sea",     rom:"si",      es:"mar" },
    { han:"mountain",rom:"maunten", es:"montaña" },
    { han:"sky",     rom:"skai",    es:"cielo" },
    { han:"rain",    rom:"rein",    es:"lluvia" },
    { han:"sun",     rom:"san",     es:"sol" },
    { han:"coffee",  rom:"kofi",    es:"café" },
    { han:"tea",     rom:"ti",      es:"té" },
    { han:"meat",    rom:"mit",     es:"carne" },
    { han:"fish",    rom:"fish",    es:"pescado" },
    { han:"cheese",  rom:"chis",    es:"queso" },
    { han:"market",  rom:"market",  es:"mercado" },
    { han:"shop",    rom:"shop",    es:"tienda" },
    { han:"train",   rom:"trein",   es:"tren" },
    { han:"car",     rom:"kar",     es:"coche" },
    { han:"week",    rom:"wik",     es:"semana" },
    { han:"year",    rom:"yir",     es:"año" },
    { han:"yesterday",rom:"yesterdei",es:"ayer" },
    // --- medio ---
    { han:"neighbour",rom:"neibor",  es:"vecino", lvl:2 },
    { han:"language", rom:"languich",es:"idioma", lvl:2 },
    { han:"meeting",  rom:"miting",  es:"reunión", lvl:2 },
    { han:"holiday",  rom:"jolidei", es:"vacaciones", lvl:2 },
    { han:"mistake",  rom:"misteik", es:"error", lvl:2 },
    { han:"reason",   rom:"rison",   es:"razón", lvl:2 },
    { han:"answer",   rom:"anser",   es:"respuesta", lvl:2 },
    { han:"question", rom:"kuestion",es:"pregunta", lvl:2 },
    { han:"to explain",rom:"tu ikspléin",es:"explicar", lvl:2, verb:true },
    { han:"to decide",rom:"tu disáid",es:"decidir", lvl:2, verb:true },
    // --- avanzado ---
    { han:"experience",rom:"ikspírians",es:"experiencia", lvl:3 },
    { han:"relationship",rom:"riléishonship",es:"relación", lvl:3 },
    { han:"agreement", rom:"agríment", es:"acuerdo", lvl:3 },
    { han:"strength",  rom:"strenz",   es:"fuerza", lvl:3 },
    { han:"weakness",  rom:"wíknes",   es:"debilidad", lvl:3 },
    { han:"awareness", rom:"awérnes",  es:"conciencia", lvl:3 },
    { han:"to succeed",rom:"tu saksíd",es:"tener éxito", lvl:3, verb:true },
    { han:"to improve",rom:"tu imprúv",es:"mejorar", lvl:3, verb:true },
  ], 1, "palabra");
