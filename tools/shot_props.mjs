...
function b64ToU32(s){ const b = atob(s); const u = new Uint8Array(b.length); for (let i=0;i<b.length;i++) u[i]=b.charCodeAt(i); return new Float32Array(u.buffer); }
...
await page.goto("http://localhost:8101/tools/viewer_props.html", { waitUntil: "load" });
...
const dir = path.join(root, "test-shots/props_cells");
